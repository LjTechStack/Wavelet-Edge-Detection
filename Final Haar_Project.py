...
def haar_On_Pic(default_Pic,name):
    haar_Default_Pic_L1,haar_Default_Pic_H1 = haarX(default_Pic)           #apply haar transformation on the x-axis, return low and high pass
    haar_Default_Pic_LL1,haar_Default_Pic_LH1 = haarY(haar_Default_Pic_L1)    #apply haar thansformation on the y-axis of low pass, return lowlow and lowhigh pass
    haar_Default_Pic_HL1,haar_Default_Pic_HH1 = haarY(haar_Default_Pic_H1)    #apply haar thansformation on the y-axis of high pass, return highlow and highhigh pass   
    haar_Default_Pic_Total1 = combine(haar_Default_Pic_LH1,haar_Default_Pic_HL1,haar_Default_Pic_HH1)    #combine LH,HL,HH which represent diagonal, vertical, and horizontal edges
    
    haar_Default_Pic_L2,haar_Default_Pic_H2 = haarX(haar_Default_Pic_LL1)           #apply haar transformation on the x-axis, return low and high pass
    haar_Default_Pic_LL2,haar_Default_Pic_LH2 = haarY(haar_Default_Pic_L2)    #apply haar thansformation on the y-axis of low pass, return lowlow and lowhigh pass
    haar_Default_Pic_HL2,haar_Default_Pic_HH2 = haarY(haar_Default_Pic_H2)    #apply haar thansformation on the y-axis of high pass, return highlow and highhigh pass    
    haar_Default_Pic_Total2 = combine(haar_Default_Pic_LH2,haar_Default_Pic_HL2,haar_Default_Pic_HH2)
    
    haar_Default_Pic_L3,haar_Default_Pic_H3 = haarX(haar_Default_Pic_LL2)           #apply haar transformation on the x-axis, return low and high pass
    haar_Default_Pic_LL3,haar_Default_Pic_LH3 = haarY(haar_Default_Pic_L3)    #apply haar thansformation on the y-axis of low pass, return lowlow and lowhigh pass
    haar_Default_Pic_HL3,haar_Default_Pic_HH3 = haarY(haar_Default_Pic_H3)    #apply haar thansformation on the y-axis of high pass, return highlow and highhigh pass    
    haar_Default_Pic_Total3 = combine(haar_Default_Pic_LH3,haar_Default_Pic_HL3,haar_Default_Pic_HH3)

    haar_Default_Pic_L4,haar_Default_Pic_H4 = haarX(haar_Default_Pic_LL3)           #apply haar transformation on the x-axis, return low and high pass
    haar_Default_Pic_LL4,haar_Default_Pic_LH4 = haarY(haar_Default_Pic_L4)    #apply haar thansformation on the y-axis of low pass, return lowlow and lowhigh pass
    haar_Default_Pic_HL4,haar_Default_Pic_HH4 = haarY(haar_Default_Pic_H4)    #apply haar thansformation on the y-axis of high pass, return highlow and highhigh pass    
    ...
    for a in range(x.shape[0]):        #foreach loop for x-axis
        for b in range(x.shape[1]):    #foreach loop for y-axis
            if b == x.shape[1]-1:      #prevent array overflow
                haar_Low[a][b] = 2*haar_Low_Array[0]*x[a][b]    #apply the low array transformation for near array overflow 
                haar_High[a][b] = 0                             #apply the high array transformation for near arry overflow 
            else:
                haar_Low[a][b] = haar_Low_Array[0]*x[a][b] + haar_Low_Array[1]*x[a][b+1]    #apply the low array transformation
                haar_High[a][b] = haar_High_Array[0]*x[a][b] + haar_High_Array[1]*x[a][b+1] #apply the high array transformation
    ...
    for a in range(x.shape[0]):         #foreach loop for x-axis
        for b in range(x.shape[1]):     #foreach loop for y-axis
            if a == x.shape[0]-1:
                ...
                haar_Low[a][b] = haar_Low_Array[0]*x[a][b] + haar_Low_Array[1]*x[a+1][b]        #apply the low array transformation
                haar_High[a][b] = haar_High_Array[0]*x[a][b] + haar_High_Array[1]*x[a+1][b]     #apply the high array transformation
