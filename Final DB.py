...
def main():
    default_Lena = cv2.imread("C:\Users\Liang\Desktop\CV_Final_Project\Lena.jpg",0)    #extract image from file and make it gray scale
    default_Carriage = cv2.imread("C:\Users\Liang\Desktop\CV_Final_Project\Carriage.jpg",0) #extract image from file and make it gray scale
    default_Peppers = cv2.imread("C:\Users\Liang\Desktop\CV_Final_Project\Peppers.jpg",0)   #extract image from file and make it gray scale
...
def daubechies_On_Pic(default_Pic,name):
    daubechies_Default_Pic_L1,daubechies_Default_Pic_H1 = daubechiesX(default_Pic)           #apply daubechies transformation on the x-axis, return low and high pass
    daubechies_Default_Pic_LL1,daubechies_Default_Pic_LH1 = daubechiesY(daubechies_Default_Pic_L1)    #apply daubechies thansformation on the y-axis of low pass, return lowlow and lowhigh pass
    daubechies_Default_Pic_HL1,daubechies_Default_Pic_HH1 = daubechiesY(daubechies_Default_Pic_H1)    #apply daubechies thansformation on the y-axis of high pass, return highlow and highhigh pass   
    daubechies_Default_Pic_Total1 = combine(daubechies_Default_Pic_LH1,daubechies_Default_Pic_HL1,daubechies_Default_Pic_HH1)    #combine LH,HL,HH which represent diagonal, vertical, and horizontal edges
    
    daubechies_Default_Pic_L2,daubechies_Default_Pic_H2 = daubechiesX(daubechies_Default_Pic_LL1)           #apply daubechies transformation on the x-axis, return low and high pass
    daubechies_Default_Pic_LL2,daubechies_Default_Pic_LH2 = daubechiesY(daubechies_Default_Pic_L2)    #apply daubechies thansformation on the y-axis of low pass, return lowlow and lowhigh pass
    daubechies_Default_Pic_HL2,daubechies_Default_Pic_HH2 = daubechiesY(daubechies_Default_Pic_H2)    #apply daubechies thansformation on the y-axis of high pass, return highlow and highhigh pass    
    daubechies_Default_Pic_Total2 = combine(daubechies_Default_Pic_LH2,daubechies_Default_Pic_HL2,daubechies_Default_Pic_HH2)
    
    daubechies_Default_Pic_L3,daubechies_Default_Pic_H3 = daubechiesX(daubechies_Default_Pic_LL2)           #apply daubechies transformation on the x-axis, return low and high pass
    daubechies_Default_Pic_LL3,daubechies_Default_Pic_LH3 = daubechiesY(daubechies_Default_Pic_L3)    #apply daubechies thansformation on the y-axis of low pass, return lowlow and lowhigh pass
    daubechies_Default_Pic_HL3,daubechies_Default_Pic_HH3 = daubechiesY(daubechies_Default_Pic_H3)    #apply daubechies thansformation on the y-axis of high pass, return highlow and highhigh pass    
    daubechies_Default_Pic_Total3 = combine(daubechies_Default_Pic_LH3,daubechies_Default_Pic_HL3,daubechies_Default_Pic_HH3)

    daubechies_Default_Pic_L4,daubechies_Default_Pic_H4 = daubechiesX(daubechies_Default_Pic_LL3)           #apply daubechies transformation on the x-axis, return low and high pass
    daubechies_Default_Pic_LL4,daubechies_Default_Pic_LH4 = daubechiesY(daubechies_Default_Pic_L4)    #apply daubechies thansformation on the y-axis of low pass, return lowlow and lowhigh pass
    daubechies_Default_Pic_HL4,daubechies_Default_Pic_HH4 = daubechiesY(daubechies_Default_Pic_H4)    #apply daubechies thansformation on the y-axis of high pass, return highlow and highhigh pass    
    daubechies_Default_Pic_Total4 = combine(daubechies_Default_Pic_LH4,daubechies_Default_Pic_HL4,daubechies_Default_Pic_HH4)
...
def impluse(x,p):           #apply SP noise to the given image x by appling the probability p
    ...
    for a in range(y.shape[0]):     #foreach loop for x-axis
        for b in range(y.shape[1]): #foreach loop for y-axis
            ...
            y[a][b] = 0 if rand < p else 255 if rand > thresh else x[a][b]  #add salt and pepper pixel depending on probability
        ...
        for b in range(x.shape[1]):    #foreach loop for y-axis
            if a == x.shape[0]-1:      #prevent array overflow
                ...
                daubechies_Low[a][b] = (daubechies_Low_Array[0]*x[a][b] + daubechies_Low_Array[1]*x[a+1][b] +
                                        daubechies_Low_Array[2]*x[a+1][b] + daubechies_Low_Array[3]*x[a+1][b]) #apply the low array transformation for near array overflow 
                daubechies_High[a][b] = (daubechies_High_Array[0]*x[a][b] + daubechies_High_Array[1]*x[a+1][b] +
                                         daubechies_High_Array[2]*x[a+1][b] + daubechies_High_Array[3]*x[a+1][b]) #apply the high array transformation for near arry overflow
            elif a == x.shape[0]-3:      #prevent array overflow
                daubechies_Low[a][b] = (daubechies_Low_Array[0]*x[a][b] + daubechies_Low_Array[1]*x[a+1][b] +
                                        daubechies_Low_Array[2]*x[a+2][b] + daubechies_Low_Array[3]*x[a+2][b]) #apply the low array transformation for near array overflow 
                daubechies_High[a][b] = (daubechies_High_Array[0]*x[a][b] + daubechies_High_Array[1]*x[a+1][b] +
                                         daubechies_High_Array[2]*x[a+2][b] + daubechies_High_Array[3]*x[a+2][b]) #apply the high array transformation for near arry overflow
            else:
                daubechies_Low[a][b] = (daubechies_Low_Array[0]*x[a][b] + daubechies_Low_Array[1]*x[a+1][b] +
                                        daubechies_Low_Array[2]*x[a+2][b] + daubechies_Low_Array[3]*x[a+3][b])    #apply the low array transformation
                daubechies_High[a][b] = (daubechies_High_Array[0]*x[a][b] + daubechies_High_Array[1]*x[a+1][b] +
                                         daubechies_High_Array[2]*x[a+2][b] + daubechies_High_Array[3]*x[a+3][b]) #apply the high array transformation
    
    daubechies_Low = down.zoom(daubechies_Low,[1,.5],order = 0)             #downsize the image by cutting it in half in the y-axis
    daubechies_High = down.zoom(daubechies_High,[1,.5], order = 0)          #downsize the image by cutting it in half in the y-axis
    return daubechies_Low,daubechies_High       #return daubechies_Low and daubechies_High
...
def combine(LH,HL,HH):          #combine LH,HL,HH which represent diagonal, vertical, and horizontal edges
    ...
    for a in range(Total.shape[0]):     #foreach loop for x-axis
        for b in range(Total.shape[1]): #foreach loop for y-axis
            Total[a][b] = math.sqrt((LH[a][b]*LH[a][b])+(HL[a][b]*HL[a][b])+(HH[a][b]*HH[a][b]))  #store total of the 3 combine images into Total  
